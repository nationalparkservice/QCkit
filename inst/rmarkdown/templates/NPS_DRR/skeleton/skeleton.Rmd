...
This data package is available for download from the NPS DataStore at `r data_package_doi` and can be directly imported into R data frames using the NPSutils package (Baker et al., 2024) and the following code:
