...
check_dc_cols <- function(working_df) {
  #does not include measurementOrFact or resourceRelationship classes and thus has 179 items vs 196 in the list below.

  dwcterms <- data.frame(
    DarwinCore = c("type", "modified", "language", "license", "rightsHolder",
                   ...
                   "recordNumber", "recordedBy", "recordedByID",
                   "individualCount", "organismQuantity",
                   "organismQuantityType", "sex", "lifeStage",
                   ...
                   "materialSampledID", "eventID", "parentEventID",
                   "fieldNumber", "eventDate", "eventTime", "startDayOfYear",
                   ...
                   "eventRemarks", "locationID", "higherGeographyID",
                   "higherGeography", "continent", "waterBody", "islandGroup",
                   "island", "country", "countryCode", "stateProvince",
                   "county", "municipality", "locality", "verbatimLocality",
                   "minimumElevationInMeters", "maximumElevationInMeters",
                   "verbatimElevation", "verticalDatum", "minimumDepthInMeters",
                   ...
                   "verbatimLongitude", "verbatimCoordinateSystem",
                   "verbatimSRS", "footprintWKT", "footprintSRS",
                   ...
                   "group", "formation", "member", "bed", "identificationID",
                   "verbatimIdentification", "identificationQualifier",
                   "typeStatus", "identifiedBy", "identifiedByID",
                   "dateIdentified", "ientificationReferences",
                   ...
                   "naemAccordingToID", "naemPublishedInID",
                   ...
                   "order", "family", "subfamily", "genus", "genericName",
                   ...
                   "nomenclaturalStatus", "taxonRemarks", "measurementID",
                   ...
                   "measurementRemarks", "resourceRelationshipID", "resourceID",
                   "reationshipOfResourceID", "relatedResourceID",
  ...
  DCtable <- data.frame(DCproper = DCproper,
